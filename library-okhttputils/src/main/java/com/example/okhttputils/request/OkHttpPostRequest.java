...
public class OkHttpPostRequest extends OkHttpRequest {
    ...
    protected OkHttpPostRequest(String url, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file) {
    ...
    protected OkHttpPostRequest(Context context, String url, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file) {
